                        ...
                        <div class="row">
                            <div class="col-lg-8 d-none d-lg-block">
                                <div class="header-contact-info">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="fas fa-phone-alt"></i> +(254)783 027-111 </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <i class="fas fa-map-marker-alt"></i> The Spur Mall, Exit 12-13 off Thika
                                            Super Highway
                                            1st Floor, Suite B-79, Ruiru-Kenya
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="bottom-header">
                    <div class="container d-flex justify-content-between align-items-center">
                        <div class="site-identity">
                            <p class="site-title">
                                <a href="index.html">
                                    <img loading="lazy" class="white-logo" src="assets/images/travele-logo.png"
                                        alt="logo">
                                    <img loading="lazy" class="black-logo" src="assets/images/travele-logo1.png"
                                        alt="logo">
                                </a>
                            </p>
                        </div>
            ...
            <main id="content" class="site-main">
                ...
                <section class="inner-banner-wrap">
                    <div class="inner-baner-container"
                        style="background-image: url(assets/images/inner-banner-1.png);">
                        <div class="container">
                            ...
                            <div class="col-md-6">
                                <div class="service-content-wrap">
                                    <div class="service-content">
                                        ...
                                        <p>Porro ipsum amet eiusmod, quae voluptate, architecto posuere risus imperdiet
                                            gravida porttitor, penatibus nemo dictumst quasi habitant ut mollit.</p>
                                    </div>
                                    <figure class="service-img">
                                        <img loading="lazy" src="assets/images/img30.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="service-content-wrap">
                                    ...
                                    <figure class="service-img">
                                        <img loading="lazy" src="assets/images/img31.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="service-content-wrap">
                                    ...
                                    <figure class="service-img">
                                        <img loading="lazy" src="assets/images/img32.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="service-content-wrap">
                                    ...
                                    <figure class="service-img">
                                        <img loading="lazy" src="assets/images/img33.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-8 offset-lg-2">
                                    ...
                                    <p>Mollit voluptatem perspiciatis convallis elementum corporis quo veritatis aliquid
                                        ...
                                        Nostrum magnis maxime curae placeat.</p>
                                </div>
                            </div>
                        </div>
                        <div class="callback-counter-wrap">
                            <div class="counter-item">
                                <div class="counter-item-inner">
                                    <div class="counter-icon">
                                        <img loading="lazy" src="assets/images/icon1.png" alt="">
                                    </div>
                            ...
                            <div class="counter-item">
                                <div class="counter-item-inner">
                                    <div class="counter-icon">
                                        <img loading="lazy" src="assets/images/icon2.png" alt="">
                                    </div>
                                    <div class="counter-content">
                                        <span class="counter-no">
                            ...
                            <div class="counter-item">
                                <div class="counter-item-inner">
                                    <div class="counter-icon">
                                        <img loading="lazy" src="assets/images/icon3.png" alt="">
                                    </div>
                                    <div class="counter-content">
                                        <span class="counter-no">
                            ...
                            <div class="counter-item">
                                <div class="counter-item-inner">
                                    <div class="counter-icon">
                                        <img loading="lazy" src="assets/images/icon4.png" alt="">
                                    </div>
                                    <div class="counter-content">
                                        <span class="counter-no">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <aside class="widget widget_text">
                                    ...
                                    <div class="award-img">
                                        <a href="#"><img loading="lazy" src="assets/images/logo6.png"
                                                alt=""></a>
                                        <a href="#"><img loading="lazy" src="assets/images/logo2.png"
                                                alt=""></a>
                                    </div>
                                </aside>
                            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2 text-center">
                                <div class="footer-logo">
                                    <a href="#"><img loading="lazy" src="assets/images/travele-logo.png"
                                            alt=""></a>
                                </div>
                            </div>
                            <div class="col-md-5">
